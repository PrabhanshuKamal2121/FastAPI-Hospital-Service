...
@app.get("/about")
def about():
    return{'message':'A fully functional API to manage your paitient records'}
...
# http://127.0.0.1:8000/sort?sort_by=height both these links work, one with order and one without order